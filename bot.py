...
async def main():
    print("Бот запущено...")
    await init_db()
    dp.message.register(auto_register_user)
    dp.message.register(handle_start)
    dp.message.register(handle_commands)
    dp.message.register(handle_balance)
    dp.message.register(handle_buy_menu_or_back)
    dp.message.register(handle_buy_item)
    dp.message.register(handle_adjust_balance)
    dp.message.register(handle_rating)
    dp.message.register(handle_admins)
    dp.message.register(handle_add_admin)
    dp.message.register(handle_remove_admin)
